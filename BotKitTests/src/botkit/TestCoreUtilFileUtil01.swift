...
class TestCoreUtilFileUtil01 : TestBase {
    ...
    func testBasic01() {
        ...
        XCTAssertEqual(nil, File.ROOT.parent)
        XCTAssertEqual(File("/.."), File("/..").mkdirs())
        XCTAssertEqual(File("/.."), File("/../..").parent)
        XCTAssertEqual(File("/"), File("/../..").parent?.parent)
        XCTAssertEqual(nil, File("/../..").parent?.parent?.parent)
